...
function rara_business_change_comment_form_default_fields( $fields ){
    ...
    $fields['header_email'] = '<p class="comment-form-email"><label for="email">' . esc_html__( 'Email', 'rara-business' ) . '<span class="required">*</span></label><input id="email" name="email" placeholder="' . esc_attr__( 'Email*', 'rara-business' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';
...
function rara_business_change_comment_form_defaults( $defaults ){
    ...
    $defaults['comment_field'] = '<p class="comment-form-comment"><label for="comment">' . esc_html__( 'Comment', 'rara-business' ) . '</label><textarea id="comment" name="comment" placeholder="' . esc_attr__( 'Comment', 'rara-business' ) . '" cols="45" rows="8" aria-required="true"></textarea></p>';
...
if( ! function_exists( 'rara_business_move_comment_field_to_bottom' ) ) :
/**
 ...
 */
function rara_business_move_comment_field_to_bottom( $fields ) {
...
add_filter( 'comment_form_fields', 'rara_business_move_comment_field_to_bottom' );
